...
The extra-credit version of the problem gives costs that can be negative. The solution is a dynamic programming solution. I did not come up with this solution during the competition but I've implemented the following solution using a pure lazy tree structure for memoizing the solutions:
